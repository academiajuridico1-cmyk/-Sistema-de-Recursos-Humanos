...
const sidebarItems = [
  { name: 'Início', icon: LayoutDashboard, href: '/employee' },
  { name: 'Meu Perfil', icon: User, href: '/employee/profile' },
  { name: 'Férias e Pedidos', icon: Calendar, href: '/employee/vacations' },
  { name: 'Meu Departamento', icon: Users, href: '/employee/department' },
];
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 z-40">
          <div className="flex items-center bg-slate-100 rounded-full px-4 py-2 w-96">
            ...
            <input 
              type="text" 
              placeholder="Pesquisar pedidos, colegas..." 
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 pl-6 border-l border-slate-200">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-semibold text-slate-900">João Funcionário</p>
